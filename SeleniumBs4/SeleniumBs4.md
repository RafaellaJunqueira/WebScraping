...
3. O Beautiful soup só consegue mexer em objetos que sejam do tipo dele, do tipo bs4, por assim dizer. Como o case começou com Selenium, é preciso transformar aquele objeto selenium para um objeto bs4, por isso fazemos o _parse_ de um pra outro.
